...
namespace LoginRegisterUsingIdentity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddIdentity<LoginRegisterUsingIdentityUser, LoginRegisterUsingIdentityUser>(cfg =>
            //{
  ...
  //options.UseSqlServer(Configuration.GetConnectionString("LoginRegisterUsingIdentityContextConnection")));
  //          services.AddDefaultIdentity<LoginRegisterUsingIdentityUser>()
  //          .AddEntityFrameworkStores<LoginRegisterUsingIdentityContext>();
